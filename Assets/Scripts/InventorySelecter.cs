...
public class InventorySelecter : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (Player.GetComponent<MovementReworked>().SecondaryCam.GetComponent<BetterWeaponSwitchForInventory>().CurrentWeaponObject.gameObject.GetComponent<grenadeScript>() != null)
            {
            ...
            else if (Player.GetComponent<MovementReworked>().SecondaryCam.GetComponent<BetterWeaponSwitchForInventory>().CurrentWeaponObject.gameObject.GetComponent<WeaponControl>() != null)
            {
